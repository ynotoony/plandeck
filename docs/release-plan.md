...
Theme: complete the first post-Beta compatibility and Tool-support changes while keeping the public release path reproducible.
...
- Core tests, App checks, and fixture/secret scan pass on every included PR and on `main`.
