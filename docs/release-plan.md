...
| [#16](https://github.com/ynotoony/plandeck/issues/16) GitHub Release auto-update | `feat/gh-16-auto-update` | In progress | Adds signed in-app updates and optional startup checks. |
