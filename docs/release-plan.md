...
| [#16](https://github.com/ynotoony/plandeck/issues/16) GitHub Release auto-update | [PR #17](https://github.com/ynotoony/plandeck/pull/17) | In review | Adds signed in-app updates and optional startup checks. |
